...
void main() {
  group('FFRRouteLogger Tests', () {
    ...
    setUp(() {
      ...
      routeWithoutname = MaterialPageRoute(
        builder: (_) => const SizedBox(),
      );
    ...
    test('didPush executes without throwing errors', () {
      expect(() => logger.didPush(routeWithname, previousRoute), returnsNormally);
      expect(() => logger.didPush(routeWithoutname, previousRoute), returnsNormally);
    });

    test('didPop executes without throwing errors', () {
      expect(() => logger.didPop(routeWithname, previousRoute), returnsNormally);
      expect(() => logger.didPop(routeWithoutname, previousRoute), returnsNormally);
    });

    test('didRemove executes without throwing errors', () {
      expect(() => logger.didRemove(routeWithname, previousRoute), returnsNormally);
      expect(() => logger.didRemove(routeWithoutname, previousRoute), returnsNormally);
    });
    ...
    test('didReplace executes without throwing errors', () {
      ...
      expect(
        () => logger.didReplace(newRoute: routeWithoutname, oldRoute: previousRoute),
        returnsNormally,
      );
